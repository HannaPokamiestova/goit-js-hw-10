...
var _fetchCounties = require("./js/fetch-counties");
...
function onInput() {
    ...
    if (!searchCountry.length) return;
    (0, _fetchCounties.fetchCountries)(searchCountry).then((countries)=>{
...
function printCountryList(countries) {
    const countryListHTML = countries.map((country)=>`<li>
...
},{"./css/styles.css":"1CY4s","lodash.debounce":"3JP5n","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./js/fetch-counties":"hTYb3"}],"1CY4s":[function() {},{}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"hTYb3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchCountries", ()=>fetchCountries);
function fetchCountries(name) {
    return fetch(`https://restcountries.com/v3.1/name/${name}?
fields=name,capital,population,flags,languages`).then((response)=>{
